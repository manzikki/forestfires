...
grep "\-01" allc.txt | grep SEA | grep PM | sed 's/^.....//' | sed 's/-/,/' | sed 's/01 .*day: //' | sed 's/ .*//' >> jan.pm25.csv
echo "Year,Value" > feb.pm25.csv
grep "\-02" allc.txt | grep SEA | grep PM | sed 's/^.....//' | sed 's/-/,/' | sed 's/02 .*day: //' | sed 's/ .*//' >> feb.pm25.csv
echo "Year,Value" > mar.pm25.csv
grep "\-03" allc.txt | grep SEA | grep PM | sed 's/^.....//' | sed 's/-/,/' | sed 's/03 .*day: //' | sed 's/ .*//' >> mar.pm25.csv
echo "Year,Value" > apr.pm25.csv
grep "\-04" allc.txt | grep SEA | grep PM | sed 's/^.....//' | sed 's/-/,/' | sed 's/04 .*day: //' | sed 's/ .*//' >> apr.pm25.csv
echo "Year,Value" > may.pm25.csv
grep "\-05" allc.txt | grep SEA | grep PM | sed 's/^.....//' | sed 's/-/,/' | sed 's/05 .*day: //' | sed 's/ .*//' >> may.pm25.csv
echo "Year,Value" > jun.pm25.csv
grep "\-06" allc.txt | grep SEA | grep PM | sed 's/^.....//' | sed 's/-/,/' | sed 's/06 .*day: //' | sed 's/ .*//' >> jun.pm25.csv
echo "Year,Value" > jul.pm25.csv
grep "\-07" allc.txt | grep SEA | grep PM | sed 's/^.....//' | sed 's/-/,/' | sed 's/07 .*day: //' | sed 's/ .*//' >> jul.pm25.csv
echo "Year,Value" > aug.pm25.csv
grep "\-08" allc.txt | grep SEA | grep PM | sed 's/^.....//' | sed 's/-/,/' | sed 's/08 .*day: //' | sed 's/ .*//' >> aug.pm25.csv
echo "Year,Value" > sep.pm25.csv
grep "\-09" allc.txt | grep SEA | grep PM | sed 's/^.....//' | sed 's/-/,/' | sed 's/09 .*day: //' | sed 's/ .*//' >> sep.pm25.csv
echo "Year,Value" > oct.pm25.csv
grep "\-10" allc.txt | grep SEA | grep PM | sed 's/^.....//' | sed 's/-/,/' | sed 's/10 .*day: //' | sed 's/ .*//' >> oct.pm25.csv
echo "Year,Value" > nov.pm25.csv
grep "\-11" allc.txt | grep SEA | grep PM | sed 's/^.....//' | sed 's/-/,/' | sed 's/11 .*day: //' | sed 's/ .*//' >> nov.pm25.csv
echo "Year,Value" > dec.pm25.csv
grep "\-12" allc.txt | grep SEA | grep PM | sed 's/^.....//' | sed 's/-/,/' | sed 's/12 .*day: //' | sed 's/ .*//' >> dec.pm25.csv
