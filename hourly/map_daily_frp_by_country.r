...
#This program gets a NetCFD file (day or month) from the command line and creates
#FRP maps of the given country for each of the
#dates.
...
#atime_data = brick(aNCfile, var="time")
#atime_data
